...
def parse_answer(doc_tokens, tokens_for_postprocessing, 
    ...
    parser.add_argument("--triton-server-url", type=str, default="triton:8000", 
    ...
    parser.add_argument('--vocab_file',
                        type=str, default="/dli/task/vocab", required=False,
    ...
    return get_answer(doc_tokens, tokens_for_postprocessing, 
